...
-(void)doneButtonPressed:(UIButton*)butt 
{
    [self dismissViewControllerAnimated:YES completion:^{
            [[[HPEditorManager sharedInstance] editorViewController] handleDoneSettingsButtonPress:nil];
        }];
}
...
NSArray *getCells()
{
    return @[
            @{
                    @"Title":[HPUtility localizedItem:@"HOMESCREEN"],
                    @"Items":@[
                    @{
                            @"Cell":@"Switch",
                    ...
                    @{
                            @"Cell":@"Switch",
                            @"Title":[HPUtility localizedItem:@"CENTER_ICONS"],
                            @"Key":@"HPDataIconCenter"
                    }]
            },
            @{
                    @"Title":[HPUtility localizedItem:@"DOCK"],
                    @"Items":@[
                    @{
                            @"Cell":@"Switch",
                    ...
                    @{
                            ...
                            @"Key":@"HPDataHideDockBG"
                    },
                    @{
                            @"Cell":@"Switch",
                            @"Title":[HPUtility localizedItem:@"FORCE_IPX_DOCK"],
                            @"Key":@"HPDataModernDock"
                    }]
            },
            @{
                    @"Title":[HPUtility localizedItem:@"FOLDERS"],
                    @"Items":@[
                    @{
                            @"Cell":@"Switch",
                            @"Title":@"Folder Config Disabled",
                            @"Key":@"HPDataFolderConfigDisabled"
                    },
                    @{
                            @"Cell":@"Switch",
                            @"Title":[HPUtility localizedItem:@"HIDE_ICON_LABELS"],
                            @"Key":@"HPDataFolderIconLabels"
                    },
                    @{
                            @"Cell":@"Switch",
                            @"Title":[HPUtility localizedItem:@"HIDE_BADGES"],
                            @"Key":@"HPDataFolderIconBadges"
                    },
                    @{
                            @"Cell":@"Switch",
                            @"Title":[HPUtility localizedItem:@"CENTER_ICONS"],
                            @"Key":@"HPDataFolderIconCenter"
                    }]
            },
            @{
